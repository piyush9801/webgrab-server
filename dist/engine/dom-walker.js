...
exports.EXTRACTED_STYLE_PROPERTIES = void 0;
exports.getDomWalkerScript = getDomWalkerScript;
/**
 ...
 */
exports.EXTRACTED_STYLE_PROPERTIES = [
    'display',
    'position',
    'width',
    'height',
...
function getDomWalkerScript() {
    return `
  (function walkDOM() {
    const STYLE_PROPS = ${JSON.stringify(exports.EXTRACTED_STYLE_PROPERTIES)};
